...
WASM_MISC_OPCODE(F4ConvertS, 0x184, Limit, true)
WASM_MISC_OPCODE(F4ConvertU, 0x185, Limit, true)
WASM_MISC_OPCODE(F2ConvertS, 0x186, Limit, true)
WASM_MISC_OPCODE(F2ConvertU, 0x187, Limit, true)
WASM_MISC_OPCODE(I4TruncS, 0x188, Limit, true)
WASM_MISC_OPCODE(I4TruncU, 0x189, Limit, true)
